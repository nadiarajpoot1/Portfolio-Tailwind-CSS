      ...
      <div className="grid md:grid-cols-2 gap-10 md:gap-6">
        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-3 items-center" data-aos="zoom-in-up">
            <AiOutlineMail size={30} /> <a href="mailto:abc@gmail.com">abc@gmail.com</a>
          </div>
          <div className="flex gap-3 items-center" data-aos="zoom-in-up">
        ...
        <div className="space-y-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col gap-1" data-aos="zoom-in-up">
              ...
              <textarea
                className="bg-transparent border border-emerald-700 min-h-[100px] resize-none"
                id="msg"
            ...
            <button
              type="submit"
              className="bg-emerald-700 p-2 px-6 hover:bg-accent-dark transition duration-300"
              data-aos="zoom-in-up"
            >
              Send
            </button>
